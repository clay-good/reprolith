...
paper: metformin's plasma Cmax after a single oral dose (6.1 and 11.2 nmol/mL) and under
twice-daily dosing (6.9, 12.8 and 18.5), which are what that paper's *own model* reports. Every
