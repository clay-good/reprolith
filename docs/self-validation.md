...
- **The same contracts throughout.** All four classes flow through one catalog lifecycle, one
...
python -m pytest tests/test_logical_cross_validation.py  # logical (reads committed CANA references)
```
